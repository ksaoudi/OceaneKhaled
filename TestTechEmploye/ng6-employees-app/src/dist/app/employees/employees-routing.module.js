...
var filter_employees_component_1 = require("./filter-employees.component");
var employeesRoutes = [
    {
        path: 'employees',
        children: [
            { path: 'all', component: filter_employees_component_1.EmployeesFilterComponent }
        ]
    }
];
var EmployeesRoutingModule = /** @class */ (function () {
    ...
    EmployeesRoutingModule = __decorate([
        core_1.NgModule({
            imports: [
                router_1.RouterModule.forChild(employeesRoutes)
            ],
            exports: [
